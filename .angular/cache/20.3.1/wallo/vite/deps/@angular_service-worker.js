import {
  ...
  ɵɵdefineNgModule,
  ɵɵinject
} from "./chunk-RD2PWORV.js";
import "./chunk-6ZPAEFZE.js";
import {
  NEVER
} from "./chunk-UPEYA6JG.js";
import {
  Observable,
  Subject,
  filter,
...
var _NgswCommChannel = class _NgswCommChannel {
  serviceWorker;
  worker;
  registration;
  events;
  constructor(serviceWorker, injector) {
    ...
    if (!serviceWorker) {
      ...
      const updateController = /* @__PURE__ */ __name(() => {
        const {
          controller
        } = serviceWorker;
        if (controller === null) {
      ...
      const messageListener = /* @__PURE__ */ __name((event) => {
        const {
          data
        } = event;
        if (data?.type) {
  ...
  eventsOfType(type) {
    ...
    if (typeof type === "string") {
      filterFn = /* @__PURE__ */ __name((event) => event.type === type, "filterFn");
    } else {
      filterFn = /* @__PURE__ */ __name((event) => type.includes(event.type), "filterFn");
    }
...
__name(_NgswCommChannel, "NgswCommChannel");
var NgswCommChannel = _NgswCommChannel;
var _SwPush = class _SwPush {
  ...
  unsubscribe() {
    ...
    const doUnsubscribe = /* @__PURE__ */ __name((sub) => {
      if (sub === null) {
...
__name(_SwPush, "SwPush");
__publicField(_SwPush, "ɵfac", /* @__PURE__ */ __name(function SwPush_Factory(__ngFactoryType__) {
...
__name(_SwUpdate, "SwUpdate");
__publicField(_SwUpdate, "ɵfac", /* @__PURE__ */ __name(function SwUpdate_Factory(__ngFactoryType__) {
...
function ngswAppInitializer() {
  ...
  ngZone.runOutsideAngular(() => {
    ...
    const onControllerChange = /* @__PURE__ */ __name(() => sw.controller?.postMessage({
      action: "INITIALIZE"
    }), "onControllerChange");
...
__name(ngswAppInitializer, "ngswAppInitializer");
function delayWithTimeout(timeout) {
  return new Promise((resolve) => setTimeout(resolve, timeout));
}
__name(delayWithTimeout, "delayWithTimeout");
...
__name(ngswCommChannelFactory, "ngswCommChannelFactory");
var _SwRegistrationOptions = class _SwRegistrationOptions {
  /**
...
__name(_SwRegistrationOptions, "SwRegistrationOptions");
var SwRegistrationOptions = _SwRegistrationOptions;
...
__name(provideServiceWorker, "provideServiceWorker");
...
__name(_ServiceWorkerModule, "ServiceWorkerModule");
__publicField(_ServiceWorkerModule, "ɵfac", /* @__PURE__ */ __name(function ServiceWorkerModule_Factory(__ngFactoryType__) {
  return new (__ngFactoryType__ || _ServiceWorkerModule)();
}, "ServiceWorkerModule_Factory"));
