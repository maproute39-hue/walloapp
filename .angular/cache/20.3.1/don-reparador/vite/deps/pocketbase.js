...
var _ClientResponseError = class _ClientResponseError extends Error {
  constructor(e2) {
...
__name(_ClientResponseError, "ClientResponseError");
var ClientResponseError = _ClientResponseError;
var e = /^[\u0009\u0020-\u007e\u0080-\u00ff]+$/;
...
var i = "pb_auth";
var _BaseAuthStore = class _BaseAuthStore {
  constructor() {
...
__name(_BaseAuthStore, "BaseAuthStore");
var BaseAuthStore = _BaseAuthStore;
var _LocalAuthStore = class _LocalAuthStore extends BaseAuthStore {
...
__name(_LocalAuthStore, "LocalAuthStore");
var LocalAuthStore = _LocalAuthStore;
var _BaseService = class _BaseService {
  constructor(e2) {
    this.client = e2;
  }
};
__name(_BaseService, "BaseService");
var BaseService = _BaseService;
var _SettingsService = class _SettingsService extends BaseService {
  getAll(e2) {
...
var _RealtimeService = class _RealtimeService extends BaseService {
  constructor() {
...
__name(_RealtimeService, "RealtimeService");
var RealtimeService = _RealtimeService;
var _CrudService = class _CrudService extends BaseService {
  decode(e2) {
    return e2;
  }
  getFullList(e2, t2) {
  ...
  _getFullList(e2 = 500, t2) {
    ...
    let s2 = [], request = /* @__PURE__ */ __name((i2) => __async(this, null, function* () {
...
__name(_CrudService, "CrudService");
var CrudService = _CrudService;
...
var _RecordService = class _RecordService extends CrudService {
  constructor(e2, t2) {
...
__name(_RecordService, "RecordService");
var RecordService = _RecordService;
...
var _CollectionService = class _CollectionService extends CrudService {
  get baseCrudPath() {
...
__name(_CollectionService, "CollectionService");
var CollectionService = _CollectionService;
var _LogService = class _LogService extends BaseService {
  getList(e2 = 1, t2 = 30, s2) {
    return __async(this, null, function* () {
...
__name(_LogService, "LogService");
var LogService = _LogService;
var _HealthService = class _HealthService extends BaseService {
  check(e2) {
    return __async(this, null, function* () {
...
__name(_HealthService, "HealthService");
var HealthService = _HealthService;
var _FileService = class _FileService extends BaseService {
  getUrl(e2, t2, s2 = {}) {
...
__name(_FileService, "FileService");
var FileService = _FileService;
var _BackupService = class _BackupService extends BaseService {
  getFullList(e2) {
    return __async(this, null, function* () {
...
__name(_BackupService, "BackupService");
var BackupService = _BackupService;
var _CronService = class _CronService extends BaseService {
  getFullList(e2) {
    return __async(this, null, function* () {
...
__name(_CronService, "CronService");
var CronService = _CronService;
function isFile(e2) {
...
var _BatchService = class _BatchService extends BaseService {
  constructor() {
...
__name(_BatchService, "BatchService");
var BatchService = _BatchService;
var _SubBatchService = class _SubBatchService {
  constructor(e2, t2) {
...
__name(_SubBatchService, "SubBatchService");
var SubBatchService = _SubBatchService;
...
var Client = _Client;
var _AsyncAuthStore = class _AsyncAuthStore extends BaseAuthStore {
  constructor(e2) {
...
__name(_AsyncAuthStore, "AsyncAuthStore");
var AsyncAuthStore = _AsyncAuthStore;
export {
  AsyncAuthStore,
  BaseAuthStore,
  BatchService,
